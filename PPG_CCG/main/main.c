...
#define powerLed      UINT8_C(0x7F) //Cuong do led, tieu thu 6.4mA
...
void app_main(void){
    ...
    xTaskCreatePinnedToCore(readMAX30102_task, "max30102_test", 1024 * 10, &readMAXTask_handle, configMAX_PRIORITIES - 1, NULL, 0);
}